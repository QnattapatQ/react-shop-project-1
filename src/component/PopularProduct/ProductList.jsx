...
export const ProductList = () => {
    ...
    const productPoint = useContext(ProductSelect)
    ...
    return (
        <div className='grid grid-cols-4 max-lg:grid-cols-3 max-md:grid-cols-2 max-sm:grid-cols-1 gap-7'>
            {popularProduct.map((data, index) => (
                <div className='relative overflow-hidden group/img group/option' onClick={() => {productPoint.setProductSelect(data)}} key={index}>
                    <div className='relative'>
                        ...
                        <div>
                            ...
                            <a 
                                ...
                                bg-white rounded-full flex items-center justify-center group-hover/option:opacity-100' 
                                href="#"
                                onClick={() => {productPoint.setProductSelect(data)}}
