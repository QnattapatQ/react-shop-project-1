...
const MenProduct = () => {
    ...
    const [sortProduct, setSortProduct] = useState(menProduct);
    ...
    useEffect(() => {
        const sortData = () => {
            if(selectValue === 'default'){
                setSortProduct(
                    ...menProduct.sort((a, b) => a.number - b.number)
                );

            } else if(selectValue === 'popularity' || selectValue === 'latest'){
                setSortProduct(
                    ...menProduct.sort((a, b) => b.number - a.number)
                );
            } else if(selectValue === 'lowtohigh'){
                setSortProduct(
                    ...menProduct.sort((a, b) => a.lowPrice - b.lowPrice)
                );
            } else if(selectValue === 'hightolow'){
                setSortProduct(
                    ...menProduct.sort((a, b) => b.lowPrice - a.lowPrice)
                );
            } 
        };
        sortData();
