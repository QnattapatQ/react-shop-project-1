...
export const RelatedProductWomen = ({ womenProductId }) => {

    const [relatedWomen, setRelatedWomen] = useState(womenProduct);

    useEffect(() => {
        setRelatedWomen(
            relatedWomen.filter((data) => {
                if(data.id !== womenProductId) {
                    return data
                }
            })
        );
